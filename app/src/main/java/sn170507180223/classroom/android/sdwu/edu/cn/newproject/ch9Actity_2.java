...
public class ch9Actity_2 extends AppCompatActivity {
private ArrayList category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Myadaoter myAdapter=new Myadaoter();
        expandableListView.setAdapter(myAdapter);


    }
    //自定义数据适配器
    class Myadaoter extends BaseExpandableListAdapter{
        ...
        public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
            //得到一级数据的视图
            //为了提高运行效率，系统将之前使用的view对象传回，我们可以重复运用，避免每次实例化新对象
            if(view==null){
        ...
        public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
            ...
            String price=(String) map.get("peice");
